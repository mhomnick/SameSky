...
var laserSpeedCost : int;
var laserSpeedDescrip = "Increase sat attack speed";
...
GameController.techCost = laserSpeedCost;
GameController.descripText = laserSpeedDescrip;
}
...
if ((DestroyByContact.money >= laserSpeedCost) && (!button2Selected)){
buttonPick += 1;
...
GetComponent.<Renderer>().material.mainTexture = button2Down;
 	 ...
 	 DestroyByContact.money = DestroyByContact.money - laserSpeedCost;
 	 laserSpeedCost += laserSpeedCost;
 	 if (buttonPick > 3){
