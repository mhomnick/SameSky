			...
			*/
			...
			if ((!Input.GetKey("s")) && (!Input.GetKey("w"))){
   			...
   			if (transform.position.z > 1.2){
   				...
   				lookAt.transform.localPosition.y = Mathf.Lerp(lookAt.transform.localPosition.y, 2.22, Time.deltaTime * tiltSpeed);
   			}
  			if ((transform.position.z < 1.2) && (transform.position.z > -.5)){ 
   				...
   				lookAt.transform.localPosition.y = Mathf.Lerp(lookAt.transform.localPosition.y, 2.5, Time.deltaTime * tiltSpeed);
   			}
